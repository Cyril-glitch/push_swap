...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/01/20 13:57:55 by cycolonn          #+#    #+#             */
/*   Updated: 2026/01/20 14:00:10 by cycolonn         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_cheap_push(t_clist **stack_a, t_clist **stack_b, int size,
		int size_b)
{
	t_clist	*cheapest;
	t_moves	*mv;
